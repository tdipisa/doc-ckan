...
latex_documents = [('index', 'doc-drdsi.tex', u'LaMMA Documentation', u'ETj (GeoSolutions)', 'manual')]
...
man_pages = [('index', 'doc-drdsi', u'LaMMA Documentation', [u'ETj (GeoSolutions)'], 1)]
