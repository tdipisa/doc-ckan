...
.. glossary::
    ...
    AGPL
        ...
        CKAN is released under the `AGPL 3 license <http://www.gnu.org/licenses/agpl-3.0.html>`_.

    GPL
        The GNU General Public License is a free, copyleft license for software and other kinds of works.

        *GeoNetwork* opensource is released under the `GPL 2 license <http://www.gnu.org/licenses/old-licenses/gpl-2.0.html>`_.

        *Tolomeo* is released under the `GPL 3 license <http://www.gnu.org/licenses/gpl.html>`_.
